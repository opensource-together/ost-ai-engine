...
class Project(Base):
    ...
    owner_id = Column(UUID(as_uuid=True), ForeignKey("USER.id"))  # Project owner (from Prisma)
    ...
    tech_stacks = relationship("TechStack", secondary=ProjectTechStack.__tablename__, back_populates="projects")
    ...
    categories = relationship("Category", secondary=ProjectCategory.__tablename__, back_populates="projects")
